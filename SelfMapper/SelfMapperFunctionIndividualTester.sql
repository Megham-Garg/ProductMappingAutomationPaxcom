-- FUNCTION: public.selfmapperproductsv5(character varying, character varying, character varying, character varying, double precision, double precision, integer, double precision, character varying, integer, double precision, double precision, double precision, double precision, double precision)

-- DROP FUNCTION public.selfmapperproductsv5(character varying, character varying, character varying, character varying, double precision, double precision, integer, double precision, character varying, integer, double precision, double precision, double precision, double precision, double precision);

CREATE OR REPLACE FUNCTION public.selfmapperproductsv5(
...
AS $BODY$
BEGIN
    RETURN QUERY SELECT channel,sku,title,brand,mrp,price,subtitle, grammage, si, units
    FROM
        products
    WHERE
        CASE
        ...
        )ORDER BY channel, ABS(mrp - base_mrp) ASC, uniq_common_words(base_variant, variant) DESC;
END;
$BODY$;

ALTER FUNCTION public.selfmapperproductsv5(character varying, character varying, character varying, character varying, double precision, double precision, integer, double precision, character varying, integer, double precision, double precision, double precision, double precision, double precision)
    OWNER TO postgres;
